...
Además, la veterinaria posee un control de stock de los medicamentos a los que se les administra a las mascotas atendidas. Al quedar pocas unidades de un medicamento, el sistema lo detecta y realiza automáticamente un pedido de reposición al proveedor designado para ese medicamento.
