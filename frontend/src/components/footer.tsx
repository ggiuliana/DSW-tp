function Footer(){
    return(
    <> 
        <div className="flex flex-col items-center justify-center gap-4 bg-violet-100 px-6 py-12 w-full">
        ...
        <footer className="bg-violet-100 w-full flex p-6 border border-gray-300 place-content-between">
